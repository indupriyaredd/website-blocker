...
heading=Label(window, text ='Website Blocker' , font 
='arial') 
heading.pack() 
host_path ='C:\Windows\System32\drivers\etc\hosts' 
ip_address = '127.0.0.1' 
label1=Label(window, text ='Enter Website :' , font 
='arial 13 bold') 
label1.place(x=5 ,y=60) 
enter_Website = Text(window,font = 'arial',height='2', 
width = '40') 
...
'\n') 
                Label(window, text = "Blocked", font = 
'arial').place(x=230,y =200) 
            ...
            if web in website_lists: 
                with open (host_path , 'r+') as f: 
                    for line in file_content: 
                        if not any(website in line for 
website in website_lists):   
                            f.write(line) 
                            Label(window, text = 
"UnBlocked", font = 'arial').place(x=350,y =200) 
                    f.truncate() 
...
unblock_button = Button(window, text = 'UnBlock',font = 
'arial',pady = 5,command = Unblock ,width = 6, bg = 'royal blue1', activebackground = 'grey') 
